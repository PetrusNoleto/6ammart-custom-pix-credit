...
<!-- onload = "getPix()" -->
    ...
    <div class="paymentPixBox">
        ...
        <div id="paymentPixOrderInfoBox" class="paymentPixOrderInfoBox hidden">
            <span class="paymentPixOrderInfoBussinessName"><strong>{{$storeName}}</strong></span>
            <span class="paymentPixOrderInfoNumbers">pedido: <strong >{{$paymentOrderId}}</strong></span>
        ...
        <div class="paymentProviderBox">
            <span class="paymentProvideTitle">provedora de pagamentos: <span class="paymentProvideName"><strong>mercadopago</strong></span></span>
        </div>   
    </div> -->
...
<!-- <script>
   ...
   async function getPix(){
        ...
        const paymentDescription = `pagamento pix no valor de {{$paymentValue}} no {{$storeName}} na plataforma ${businessName}`;
        const paymentAccessToken = "{{$accessToken}}"
        console.log(paymentAccessToken)
        const paymentEmail = "{{$payerEmail}}"
        await setPixPageImage(storeImage,"teste")
        try{
    ...
    <script src = "/resources/js/mercadopagopixpageimage.js"></script>
