...
use App\Http\Payments\Pix\MercadopagoPixController;
use App\Http\Payments\Credit\MercadoPagoCreditCardController;
...
if (!$is_published) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'mercadopagocredit', 'as' => 'mercadopagocredit.'], function () {
            ...
            Route::get('failed', [MercadoPagoCreditCardController::class, 'payment_failed'])->name('failed');
        });


        Route::group(['prefix' => 'mercadopagopix', 'as' => 'mercadopagopix.'], function () {
            Route::get('pay', [MercadopagoPixController::class, 'index'])->name('index');
            Route::post('create', [MercadopagoPixController::class, 'create'])->name('create')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
            Route::post('check', [MercadopagoPixController::class, 'check'])->name('check')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
            Route::get('success', [MercadopagoPixController::class, 'payment_approved'])->name('success');
            Route::get('failed', [MercadopagoPixController::class, 'payment_failed'])->name('failed');
        });
